...
function Footer() {
  ...
  return (
    <div className=''>
        <div className={`visible  mt-14 md:mt-9 mb-9 flex flex-row  justify-center items-center ${themeMode=="dark"?"font-thin":""}`}>
      ...
      <div className={`w-full text-center ${themeMode=="dark"?"font-thin ":""} md:mb-6 mb-8  md:text-md text-sm`}>Made by Aayush &#169; Copyright 2024	</div>
    </div>
  )
}
