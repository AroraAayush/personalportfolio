...
<div className='bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]'>
       ...
       <h5 className='font-thin text-md lg:text-xl '>{experience.tenure}</h5>
       <h6 className='font-thin text-sm text-neutral-300'>{experience.location}</h6>
       </motion.div>
       <motion.div variants={InOutAnimation()} initial="initial2" whileInView="inanimation" className='lg:w-2/3 md:w-2/3  w-full md:pl-8 '> 
        <div className='flex justify-start items-center'>
          ...
          <span className='font-thin text-sm'>{experience.role}</span>

          </div>
        </div>
         <p  className='mt-3 font-thin text-md mb-3'>
          {experience.desc}
         </p>
